...
function decorate(){
  document.title='RALUVAAA · Experience V35';
  const sub=document.querySelector('#brand .sub');if(sub)sub.textContent='EXPERIENCE V35';
...
window.__RALUVAAA_V35__={version:35,decorate,assets:ASSET};
})();