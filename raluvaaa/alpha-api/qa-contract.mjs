...
await rejectsCode(()=>A.createWish({text:'I want to learn one new constellation.'}),'location_required');
const located=await A.createWish({text:'I want to learn one new constellation.',locationText:'Rennes, France'});
await rejectsCode(()=>A.wishEvent(located.wishId,{type:'correct',text:'I want to learn two new constellations.',locationText:''}),'location_required');
const corrected=await A.wishEvent(located.wishId,{type:'correct',text:'I want to learn two new constellations.',locationText:'Rennes, France'});
assert.equal(corrected.text,'I want to learn two new constellations.');
assert.equal(corrected.locationText,'Rennes, France');
await rejectsCode(()=>A.wishEvent(located.wishId,{type:'correct',text:'I want to learn two new constellations.',locationText:'Rennes, France'}),'nothing_to_correct');
await rejectsCode(()=>A.wishEvent(located.wishId,{type:'correct',text:'Reach me at edit@example.com',locationText:'Rennes, France'}),'contact_or_url');
