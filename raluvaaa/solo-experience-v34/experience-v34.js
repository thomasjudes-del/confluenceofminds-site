...
const ICONS={
  ...
  create:'<svg class="v34-icon" viewBox="0 0 64 64" aria-hidden="true" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"><path d="M23 8 51 25 37 50 9 33Z" stroke-width="4"/><path d="M19 15 47 32" stroke-width="3.4"/><circle cx="31" cy="31" r="4.5" fill="currentColor" stroke="none"/><path d="M31 27c2-5 6-7 10-6-1 5-4 8-9 9" fill="currentColor" stroke="none"/><circle cx="10" cy="42" r="3" fill="currentColor" stroke="none"/><circle cx="17" cy="47" r="2.8" fill="currentColor" stroke="none"/><circle cx="9" cy="53" r="2.5" fill="currentColor" stroke="none"/></svg>',
