...
function injectChrome(){
  ...
  const sub=document.querySelector('#brand .sub');if(sub)sub.textContent=window.RALUVAAA_SOLO?'SOLO RC · SIMULÉ':(params.has('qa')?'ALPHA V0 · QA · SIMULÉ':'ALPHA V0 · SIMULÉ');
