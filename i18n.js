  ...
  const COPY = {
    en: {
      ...
      cards: {
        ...
        kashgar: ['Chronicles of Kashgar', 'A high-fantasy initiation in Kashgar.', 'Enter Kashgar'],
        dragons: ['Shattered Dragons', 'Dragons born from ancient human experiments.', 'Wake the dragons'],
        katephomi: ['À la recherche de Katephomi Kitembe', 'A climate adventure inside an unstable game-world.', 'Enter Gamana'],
        victims: ['Authentiques Victimes', 'A psychological thriller about authorship and algorithms.', 'Open the manuscript'],
        aitalent: ['AI’s Got Talent', 'The online talent show for AI creations.', 'Visit the show'],
        wecan: ['We Can / But We Can’t', 'Human power. Collective paralysis.', 'Face the contradictions'],
        silmea: ['Créations SILMEA', 'Immersive films made entirely from sound.', 'Listen to the creations'],
    ...
    fr: {
      ...
      cards: {
        ...
        kashgar: ['Chroniques de Kashgar', 'Une initiation de fantasy au cœur de Kashgar.', 'Entrer dans Kashgar'],
        dragons: ['Shattered Dragons', 'Des dragons nés d’antiques expériences humaines.', 'Réveiller les dragons'],
        katephomi: ['À la recherche de Katephomi Kitembe', 'Une aventure climatique dans un monde-jeu instable.', 'Entrer dans Gamana'],
        victims: ['Authentiques Victimes', 'Un thriller psychologique sur l’auteur et les algorithmes.', 'Ouvrir le manuscrit'],
        aitalent: ['AI’s Got Talent', 'Le concours en ligne des créations par intelligence artificielle.', 'Voir le concours'],
        wecan: ['We Can / But We Can’t', 'Puissance humaine. Paralysie collective.', 'Affronter nos contradictions'],
        silmea: ['Créations SILMEA', 'Des films immersifs entièrement conçus par le son.', 'Écouter les créations'],
